...
const Feed = () => {
  ...
  const [feedMode, setFeedMode] = useState<"feed" | "newsletter">("feed");
          ...
          <div className="flex md:hidden items-center justify-between px-4 py-3 border-b border-border/40">
            ...
            <div className="flex items-center gap-3">
              <div className="text-right">
                ...
                <p className="text-xs text-muted-foreground">Metallurgical and Materials Engineering, VSSUT</p>
              </div>
          ...
          <>
            ...
            >
              ...
              <div className="flex-1 overflow-y-auto">
                <FeedSidebar activeChannel={activeChannel} onChannelSelect={(id) => { setActiveChannel(id); setIsMobileMenuOpen(false); }} />
              </div>
            </motion.div>
          </>
        )}
