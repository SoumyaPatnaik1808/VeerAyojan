...
export function Navbar({ items, className, defaultActive = "Home" }: NavBarProps) {
    ...
    <div className="fixed top-5 left-0 right-0 z-[9999]">
      <div className="flex justify-center pt-6">
        ...
        >
          ...
          <button
            onClick={toggleTheme}
            className="relative cursor-pointer text-white/70 hover:text-white transition-colors p-2"
